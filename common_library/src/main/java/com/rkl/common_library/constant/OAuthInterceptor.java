...
//                String me = String.valueOf(System.currentTimeMillis() / 60000);
...
//            }
            requestBuilder.addQueryParameter("showapi_appid", APIServiceConfig.API_SERVICE_ID);
            requestBuilder.addQueryParameter("showapi_sign", APIServiceConfig.API_SERVICE_KEY);
            //新的请求
